...
<html>
 <head>
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/style/kontak.css')?>">
</head>
...
<section> 
<div class="container">
  <form accept-charset="utf-8" method="POST" action="<?php echo base_url('index.php/webController/kontak_a')?>">
  <div class="kotakform"> <!-- ini tempat untuk form -->
    <table class="table-regis" width="100%">
      <tbody>
        <tr>
          <td width="30%">Pilih Kategori</td>
          <td width="70%">
              <select name="tipe_alamat" required="required">
              <option value="cs">Customer Service</option>
              <option value="spons">Sponsorship</option>
              <option value="po">Partnership Opportunity</option>
        ...
        <tr>
          ...
          <td width="70%"><input class="kotakinput" type="tel" value="" name="telepon" required="required"></input></td>
         </tr>
        <tr>
          <td width="30%">Email</td>
          <td width="70%"><input class="kotakinput" type="email" value="" name="email" required="required"></input></td>
        </tr>
        <tr>
          <td>Apa yang ingin anda sampaikan?</td>
          <td><textarea name="tell"></textarea></td>
        </tr>
      </tbody>
    </table>
    <input class="btn" type="submit" name="submit" value="Kirim"></input>
  </div>
  </form>
</div>
</section>
