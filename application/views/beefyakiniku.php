...
<div class="container">
  <div class="row">
    ...
    <ul class="nav justify-content-center">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('index.php/webController/kontakkami')?>s">Kontak<br>Kami</a>
      </li>
      <li class="nav-item">
...
<div class="container">
  ...
  <div class="row">
    <div class="col-sm-4" style="margin-left: 50px">
      ...
      <h5 class="card-title" style="color:#D42227">Beef Yakiniku</h5>
    </div>
    <table class="table table-sm" style="width: 60%; margin-left: 10px">
      <tbody>
        ...
        <tr>
          ...
          <td width="70%" class="tekss">Daging sapi premium yang dimasak dengan potongan bawang bombay dan paprika hijau menggunakan saus yakiniku khas HokBen</td>
        </tr>
        <tr>
