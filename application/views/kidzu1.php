...
<div class="container">
  ...
  <div class="row">
    <div class="col-sm-4" style="margin-left: 50px">
      ...
      <h5 class="card-title" style="color:#D42227">Paket Kidzu 1</h5>
    </div>
    <table class="table table-sm" style="width: 60%; margin-left: 10px">
      <tbody>
        ...
        <tr>
          ...
          <td width="70%" class="tekss">
Produk olahan daging ayam, digulung dengan telur dadar dan dimasak dengan metode Deep Frying Oil, telur orak-arik, tanpa tambahan perasa, dan nasi yang dimasak dengan beras spesial HokBen.</td>
        </tr>
        <tr>
