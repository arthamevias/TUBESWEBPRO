...
<div class="container">
  <div id="submenu">
    <ul class="list-group list-group-horizontal-xl">
      ...
      <li class="list-group-item">
        <a href="<?php echo base_url('index.php/webController/sidedishes')?>" id="now"" >Side Dish</a>
      </li>
      <li class="list-group-item">
  ...
  <div class="row">
    <div class="col-sm-3">
      <img src="<?php echo base_url('assets/img/sidedish/ffs.jpg')?>" class="card-img-top" alt="...">
        ...
        <div>
         <a href="<?php echo base_url('index.php/webController/ffs')?>" class="readmore">Lihat Selengkapnya</a>
