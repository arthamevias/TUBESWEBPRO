    ...
    <table class="table table-sm" style="width: 60%; margin-left: 10px">
      <tbody>
        ...
        <tr>
          ...
          <td width="70%" class="tekss">Daging sapi premium yang dimasak dengan potongan bawang bombay dan menggunakan saus teriyaki khas HokBen</td>
        </tr>
        <tr>
