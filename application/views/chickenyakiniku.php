...
<div class="container">
  ...
  <div class="row">
    <div class="col-sm-4" style="margin-left: 50px">
      ...
      <h5 class="card-title" style="color:#D42227">Chicken Yakiniku</h5>
    </div>
    <table class="table table-sm" style="width: 60%; margin-left: 10px">
      <tbody>
        ...
        <tr>
          ...
          <td width="70%" class="tekss">Daging ayam tanpa tulang yang dimasak dengan potongan bawang bombay dan saus yakiniku khas HokBen.</td>
        </tr>
        <tr>
