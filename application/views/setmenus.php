...
<div class="container">
  <div id="submenu">
    <ul class="list-group list-group-horizontal-xl">
      ...
      <li class="list-group-item">
        <a href="<?php echo base_url('index.php/webController/setmenus')?>"id="now" >Set Menu</a>
      </li>
    </ul>
  </div>
  <br>
  <div class="row">
    ...
    <div class="row">
    <div class="col-sm-3">
      <img src="s<?php echo base_url('assets/img/setmenu/omiyage4.jpg')?>" class="card-img-top" alt="...">
