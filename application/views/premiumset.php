...
<div class="container">
  ...
  <div class="row">
    <div class="col-sm-4" style="margin-left: 50px">
      ...
      <h5 class="card-title" style="color:#D42227">Premium Set Beef Yakiniku</h5>
    </div>
      ...
      <tbody>
        <tr>
          ...
          <td width="70%" class="tekss">
            <img src="<?php echo base_url('assets/img/sapi.png')?>">
          </td><br>
        </tr>
        <tr>
          <td width="30%" class="teks">Komposisi</td>
          <td width="70%" class="tekss">Beef Yakiniku, Chicken Katsu, Nasi, Sup, Salad dan Ocha. *Salad dan sup hanya tersedia untuk makan di tempat.</td>
        </tr>
        <tr>
          ...
          <td width="70%" class="tekss">
            <div class="row">
              <div>
                ...
                <p class="mass">413 kkal</p>
              </div>
              <div style="margin-left: 30px">
                <p style="text-align: center;"><img src="<?php echo base_url('assets/img/protein.png')?>g"></p>
                <p style="margin-top: -10px; font-size: 12px; text-align: center">Protein</p>
                <p class="mass">37,9 g</p>
              </div>
              <div style="margin-left: 40px">
                <p style="text-align: center;"><img src="<?php echo base_url('assets/img/lemaks.png')?>"></p>
                <p style="margin-top: -10px; font-size: 12px; text-align: center">Lemak</p>
                <p class="mass">29,7 g</p>
              </div>
              <div style="margin-left: 30px">
