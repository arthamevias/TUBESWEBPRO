...
<div class="container">
  <div class="back">
    <a href="linkmenu" > << Kembali ke Menu </a>
  </div>
  <div class="row">
    <div class="col-sm-4" style="margin-left: 50px">
      <img src="<?php echo base_url('assets/img/mainmenu/cteriyaki.jpg')?>" class="card-img-top" alt="...">
      <h5 class="card-title" style="color:#D42227">Chicken Teriyaki</h5>
    </div>
    <table class="table table-sm" style="width: 60%; margin-left: 10px">
      <tbody>
        ...
        <tr>
          ...
          <td width="70%" class="tekss">Daging ayam tanpa tulang yang dimasak dengan potongan bawang bombay dan saus teriyaki khas HokBen.</td>
        </tr>
        <tr>
