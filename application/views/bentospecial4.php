...
<div class="container">
  ...
  <div class="row">
    <div class="col-sm-4" style="margin-left: 50px">
      ...
      <h5 class="card-title" style="color:#D42227">Bento Special 4</h5>
    </div>
    <table class="table table-sm" style="width: 60%; margin-left: 10px">
      <tbody>
        ...
        <tr>
          ...
          <td width="70%" class="tekss">Nasi, Salad, Beef Teriyaki, Tori no Teba, Ebi Furai, Ebi Fried. *Salad hanya untuk makan di tempat</td>
        </tr>
        <tr>
          ...
          <td width="70%" class="tekss">
            <div class="row">
              ...
              <div style="margin-left: 40px">
                <p style="text-align: center;"><img src="<?php echo base_url('assets/img/lemak.png')?>lemak.png"></p>
