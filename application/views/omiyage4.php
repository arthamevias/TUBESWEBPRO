...
<div class="container">
  ...
  <div class="row">
    <div class="col-sm-4" style="margin-left: 50px">
      ...
      <h5 class="card-title" style="color:#D42227">Omiyage 4</h5>
    </div>
    <table class="table table-sm" style="width: 60%; margin-left: 10px">
      <tbody>
        ...
        <tr>
          ...
          <td width="70%" class="tekss">
Chicken katsu, Ebi Fried, Egg Chicken Roll, Edamame, Chicken Teriyaki / Yakiniku, Beef Teriyaki / Yakiniku Nasi + Acar. HokBen Omiyage merupakan Paket menu baru HokBen yang bisa dinikmati untuk berempat dengan variasi menu lengkap, praktis & nikmat.</td>
        </tr>
        <tr>
