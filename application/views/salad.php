...
<div class="container">
  ...
  <div class="row">
    <div class="col-sm-4" style="margin-left: 50px">
      ...
      <h5 class="card-title" style="color:#D42227">Salad Porsian</h5>
    </div>
    <table class="table table-sm" style="width: 60%; margin-left: 10px">
      <tbody>
        ...
        <tr>
          ...
          <td width="70%" class="tekss">Terdiri dari acar, kol serut, salad mayonaise khas HokBen dengan cara penyajian dicup.</td>
        </tr>
        <tr>
