...
<div class="container">
  ...
  <div class="row">
    <div class="col-sm-4" style="margin-left: 50px">
      ...
      <h5 class="card-title" style="color:#D42227">Shrimp Roll</h5>
    </div>
    <table class="table table-sm" style="width: 60%; margin-left: 10px">
      <tbody>
        ...
        <tr>
          ...
          <td width="70%" class="tekss">Dihasilkan dari olahan udang dibungkus dengan telur dan tepung roti, dimasak dengan metode Deep Frying Oil..</td>
        </tr>
        <tr>
