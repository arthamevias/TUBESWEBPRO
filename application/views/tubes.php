...
<html>
 <head>
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/style/styletubes.css') ?>">
</head>
  ...
  <div class="row">
    ...
    <ul class="nav justify-content-center">
      ...
      <li>
        ...
        <a id="kotak-merah" href="<?php echo base_url('index.php/webController/step1')?>" style="background: url('<?php echo base_url('assets/img/newbag.png')?>') no-repeat scroll 21px 11px #D42227;"></a>
      </li>
    </ul>
  </div>
</div>
