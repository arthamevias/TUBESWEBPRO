...
<div class="container">
  ...
  <div class="row">
    <div class="col-sm-4" style="margin-left: 50px">
      ...
      <h5 class="card-title" style="color:#D42227">Sukiyaki</h5>
    </div>
    <table class="table table-sm" style="width: 60%; margin-left: 10px">
      <tbody>
        ...
        <tr>
          ...
          <td width="70%" class="tekss">
Dibuat dari daging sapi premium, tahu sutra jepang, shiratake, sawi putih, daun bawang, bawang bombay dan dimasak dengan saus sukiyaki khas HokBen.</td>
        </tr>
        <tr>
