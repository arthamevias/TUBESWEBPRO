...
<div class="container">
  <div id="submenu">
    <ul class="list-group list-group-horizontal-xl">
      ...
      <li class="list-group-item">
        <a href="<?php echo base_url('index.php/webController/beverage')?>" id="now">Beverages</a>
      </li>
      <li class="list-group-item">
  ...
  <div class="row">
    ...
    <div class="col-sm-3">
      <img src="<?php echo base_url('assets/img/beverages/jus.jpg')?>" class="card-img-top" alt="...">
        ...
        <div>
         <a href="<?php echo base_url('index.php/webController/jus')?>" class="readmore">Lihat Selengkapnya</a>
         <a href="#" class="pesan">Pesan</a>
        </div>
    </div>
    <div class="col-sm-3">
...
<footer id="footer" class="clearfix text-center full-grid">
    <div class="bgfooter_l"></div>
    <div class="bgfooter_r"></div>
    <div class="fluidhead clearfix">
        <div class="left grid-3-foot">
            <div class="clearfix">
                <img class="halal left" src="halal.png"></img>
        ...
        <div class="left grid-3-foot text-right">
          <p>
            ...
            <a class="social fb" title="Facebook" target="_blank" href="https://www.facebook.com/pages/Hoka-Hoka-bento/22801653893"></a>
            <a class="social twitter" title="Twitter" target="_blank" href="https://twitter.com/HokBen"></a>
            <a class="social youtube" title="Youtube" target="_blank" href="https://www.youtube.com/hokbenable"></a>
          </p>
        </div>
    </div>
</footer>
