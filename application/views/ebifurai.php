...
<div class="container">
  <div class="back">
    <a href="<?php echo base_url('index.php/webController/index')?>" > << Kembali ke Menu </a>
  </div>
  <div class="row">
    ...
    <table class="table table-sm" style="width: 60%; margin-left: 10px">
      <tbody>
        ...
        <tr>
          ...
          <td width="70%" class="tekss">Produk olahan udang yang dilapisi tepung roti, dimasak dengan metode Deep Frying Oil.</td>
        </tr>
        <tr>
