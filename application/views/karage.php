...
<div class="container">
  ...
  <div class="row">
    <div class="col-sm-4" style="margin-left: 50px">
      ...
      <h5 class="card-title" style="color:#D42227">Chicken Karaage</h5>
    </div>
      ...
      <tbody>
        <tr>
          ...
          <td width="70%" class="tekss">
            <img src="<?php echo base_url('assets/img/ayam.png')?>">
          </td><br>
        </tr>
        <tr>
          <td width="30%" class="teks">Komposisi</td>
          <td width="70%" class="tekss">Daging ayam berkualitas dan terpilih yang dimasak dengan teknik Deep Frying Oil sehingga menghasilkan tekstur tepung yang garing dan renyah serta bagian dalam yang empuk yang disajikan dengan cara ditusuk.</td>
        </tr>
        <tr>
