...
<div class="container">
  ...
  <div class="row">
    <div class="col-sm-4" style="margin-left: 50px">
      ...
      <h5 class="card-title" style="color:#D42227">Chicken Katsu</h5>
    </div>
    <table class="table table-sm" style="width: 60%; margin-left: 10px">
      <tbody>
        ...
        <tr>
          ...
          <td width="70%" class="tekss">Dada ayam tanpa tulang berlapis tepung roti dan bumbu khas HokBen yang dimasak dengan metode Deep Frying Oil sehingga renyah di luar, empuk di dalam..</td>
        </tr>
        <tr>
