...
<div class="container">
  ...
  <div class="row">
    <div class="col-sm-4" style="margin-left: 50px">
      ...
      <h5 class="card-title" style="color:#D42227">Takoyaki (3 pcs)</h5>
    </div>
    <table class="table table-sm" style="width: 60%; margin-left: 10px">
      <tbody>
        ...
        <tr>
          ...
          <td width="70%" class="tekss">Makanan kecil berbentuk bola-bola kecil dengan isian potongan bayi gurita.</td>
        </tr>
        <tr>
          ...
          <td width="70%" class="tekss">
            <div class="row">
              ...
              <div style="margin-left: 40px">
                ...
                <p class="mass">4,5 g</p>
              </div>
              <div style="margin-left: 30px">
                <p style="text-align: center;"><img src="<?php echo base_url('assets/img/kaarbohidrat.png')?>"></p>
                <p style="margin-top: -10px; font-size: 12px; text-align: center">Karbohidrat</p>
                <p class="mass">13,8 g</p>
              </div>
