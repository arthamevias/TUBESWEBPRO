...
<div class="container">
  ...
  <div class="row">
    <div class="col-sm-4" style="margin-left: 50px">
      ...
      <h5 class="card-title" style="color:#D42227">Value Set</h5>
    </div>
    <table class="table table-sm" style="width: 60%; margin-left: 10px">
      <tbody>
        ...
        <tr>
          ...
          <td width="70%" class="tekss">Egg Chicken Roll, Shrimp Roll, Nasi, Sup, Salad dan Ocha. *Salad dan sup hanya tersedia untuk makan di tempat.</td>
        </tr>
        <tr>
